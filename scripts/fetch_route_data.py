...
segments_def = [
    ...
    },
    {
        ...
        "highlight": "D6赶路日：小满→独库→G30直驱东门服务区，不购票不入园，20:30-22:00到喀兰朵",
        "lunch": "乔尔玛（13:00–14:00）",
        "road": "S315 · G217 独库北段 · G30 连霍",
        "waypoints": [
            {"id": "w6_1", "name": "伊犁尼勒克小满民宿", "coord": [82.850, 43.760], "type": "hotel", "tag": "10:00+退房(已订)", "stay": False},
            ...
            {"id": "w6_5", "name": "赛湖东门服务区", "coord": [81.348, 44.622], "type": "scenic", "tag": "D6不入园", "stay": False},
            {"id": "w6_6", "name": "喀兰朵·山湖悦己", "coord": [81.348, 44.622], "type": "hotel", "tag": "D6-D7连宿(已订) · 20:30-22:00到", "stay": True, "hotel": "喀兰朵山湖悦己"}
        ],
        "route_pts": [(82.850, 43.760), (83.697, 43.667), (84.882, 44.327), (81.348, 44.622)]
    },
    {
        "day": "D7",
        "date": "10/7 周三",
        ...
        "highlight": "10:00东门购票入园，逆时针点将台/松树头/克勒涌珠，南门出园，果子沟观景台日落，回喀兰朵",
        "lunch": "赛湖东门高白鲑（13:30–14:30）",
        "road": "赛湖环湖路 · G30",
        "waypoints": [
            {"id": "w7_1", "name": "赛湖东门新游客中心", "coord": [81.348, 44.622], "type": "scenic", "tag": "10:00+购票入园", "stay": False},
            ...
            {"id": "w7_4", "name": "赛里木湖南门", "coord": [81.183, 44.542], "type": "scenic", "tag": "南门出园（只出不进）", "stay": False},
            {"id": "w7_5", "name": "果子沟金顶观景台", "coord": [81.162, 44.482], "type": "scenic", "tag": "日落~20:05", "stay": False},
    ...
    },
    {
        ...
        "highlight": "08:00–09:00喀兰朵早餐，09:30出发(约1.5–2h)，12:00前机场还车，MU6170 13:30起飞",
        "lunch": "机场/机上（12:00后）",
        "road": "G30 · G219 机场路",
        "waypoints": [
            {"id": "w8_1", "name": "喀兰朵·山湖悦己", "coord": [81.348, 44.622], "type": "hotel", "tag": "09:30出发 · D7已出园", "stay": False},
