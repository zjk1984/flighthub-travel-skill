...
<head>
  ...
  <style>
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    /* Fixed Direction Running Car Image / Badge */
    .running-car-marker {
      width: 72px;
      height: 48px;
      position: relative;
    ...
    .speed-line:nth-child(1) { width: 14px; }
    .speed-line:nth-child(2) { width: 20px; }
    .speed-line:nth-child(3) { width: 12px; }
    ...
    .car-body-badge {
      ...
      border: 2px solid #ffffff;
      box-shadow: 0 4px 16px rgba(0, 0, 0, 0.8), 0 0 12px var(--car-color, #38bdf8);
      display: flex;
      align-items: center;
      justify-content: center;
      z-index: 2;
    ...
    .car-location-anchor {
      ...
      border-radius: 50%;
      background: #ffffff;
      box-shadow: 0 0 8px var(--car-color, #38bdf8), 0 0 0 2px var(--car-color, #38bdf8);
      z-index: 3;
    }
  </style>
</head>
...
window.setVideoState = function(state) {
  ...
  // 5. Update Running Car Marker (Fixed direction SUV/Car illustration, no rotation)
    ...
    const carHtml = `
      <div class="running-car-marker" style="--car-color: ${currentSeg.color};">
        ...
        <div class="car-body-badge">
          <!-- Realistic Self-Drive SUV Running Image / Vector -->
          <svg class="car-img-svg" viewBox="0 0 64 36" xmlns="http://www.w3.org/2000/svg">
            <defs>
            ...
            <!-- Luggage Rack on Top -->
            <rect x="20" y="3" width="22" height="2" rx="1" fill="#94a3b8"/>
            <rect x="23" y="1" width="16" height="2.5" rx="1" fill="#cbd5e1"/>
            <line x1="22" y1="5" x2="22" y2="7" stroke="#64748b" stroke-width="1.5"/>
            <line x1="40" y1="5" x2="40" y2="7" stroke="#64748b" stroke-width="1.5"/>
            <!-- Main Car Body Profile -->
            <path d="M 6,24 
                     L 10,24 
                     Q 11,20 16,20 Q 21,20 22,24 
                     L 42,24 
                     Q 43,20 48,20 Q 53,20 54,24 
                     L 60,24 
                     Q 62,24 62,22 
                     L 60,18 
                     Q 58,16 53,15 
                     ...
                     L 2,22 
                     Q 2,24 6,24 Z" 
                  fill="url(#carBodyGrad)" stroke="#0f172a" stroke-width="1.2"/>
            <!-- Windows -->
            <path d="M 23,8 L 33,8 L 41,14 L 23,14 Z" fill="url(#windowGrad)" opacity="0.9"/>
            <path d="M 13,13 L 21,9 L 21,14 L 7,14 Z" fill="url(#windowGrad)" opacity="0.9"/>
            <!-- Headlights & Taillights -->
            <polygon points="60,17 62,18 61,20 59,19" fill="#fef08a"/>
            <polygon points="3,17 2,18 2,20 4,19" fill="#ef4444"/>
            <!-- Wheels with Chrome Rims -->
            <circle cx="16" cy="24" r="5.5" fill="#1e293b" stroke="#64748b" stroke-width="1.5"/>
            <circle cx="16" cy="24" r="2.5" fill="#e2e8f0"/>
            <circle cx="48" cy="24" r="5.5" fill="#1e293b" stroke="#64748b" stroke-width="1.5"/>
            <circle cx="48" cy="24" r="2.5" fill="#e2e8f0"/>
          </svg>
        </div>
